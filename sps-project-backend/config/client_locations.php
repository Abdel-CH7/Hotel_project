...
return [
    'document_types' => ['CIN', 'Passeport', 'Carte de séjour', 'Autre'],
    'other_city_label' => 'Autre ville',
    'countries' => [
        ...
        'KM' => 'Comores', 'CG' => 'Congo-Brazzaville', 'CD' => 'Congo-Kinshasa',
        'KP' => 'Corée du Nord', 'KR' => 'Corée du Sud', 'CR' => 'Costa Rica',
        ...
        'DO' => 'République dominicaine', 'CZ' => 'Tchéquie', 'RO' => 'Roumanie',
        ...
        'TZ' => 'Tanzanie', 'TD' => 'Tchad', 'TH' => 'Thaïlande', 'TL' => 'Timor oriental',
    ...
    'morocco_regions' => [
        ['name' => 'Tanger-Tétouan-Al Hoceïma', 'cities' => ['Tanger', 'Tétouan', 'Al Hoceïma', 'Chefchaouen', 'Larache', 'Ksar El Kébir', 'Autre ville']],
        ['name' => 'L’Oriental', 'cities' => ['Oujda', 'Nador', 'Berkane', 'Taourirt', 'Jerada', 'Driouch', 'Autre ville']],
        ['name' => 'Fès-Meknès', 'cities' => ['Fès', 'Meknès', 'Ifrane', 'Taza', 'Sefrou', 'El Hajeb', 'Autre ville']],
        ['name' => 'Rabat-Salé-Kénitra', 'cities' => ['Rabat', 'Salé', 'Kénitra', 'Skhirat', 'Témara', 'Sidi Kacem', 'Sidi Slimane', 'Autre ville']],
        ['name' => 'Béni Mellal-Khénifra', 'cities' => ['Béni Mellal', 'Khénifra', 'Khouribga', 'Fquih Ben Salah', 'Azilal', 'Autre ville']],
        ['name' => 'Casablanca-Settat', 'cities' => ['Casablanca', 'Mohammedia', 'Settat', 'El Jadida', 'Berrechid', 'Benslimane', 'Nouaceur', 'Autre ville']],
        ['name' => 'Marrakech-Safi', 'cities' => ['Marrakech', 'Safi', 'Essaouira', 'El Kelâa des Sraghna', 'Chichaoua', 'Youssoufia', 'Autre ville']],
        ['name' => 'Drâa-Tafilalet', 'cities' => ['Errachidia', 'Ouarzazate', 'Zagora', 'Tinghir', 'Midelt', 'Autre ville']],
        ['name' => 'Souss-Massa', 'cities' => ['Agadir', 'Inezgane', 'Aït Melloul', 'Taroudant', 'Tiznit', 'Tata', 'Autre ville']],
        ['name' => 'Guelmim-Oued Noun', 'cities' => ['Guelmim', 'Sidi Ifni', 'Tan-Tan', 'Assa', 'Autre ville']],
        ['name' => 'Laâyoune-Sakia El Hamra', 'cities' => ['Laâyoune', 'Boujdour', 'Tarfaya', 'Es-Semara', 'Autre ville']],
        ['name' => 'Dakhla-Oued Ed-Dahab', 'cities' => ['Dakhla', 'Aousserd', 'Autre ville']],
    ],
];
