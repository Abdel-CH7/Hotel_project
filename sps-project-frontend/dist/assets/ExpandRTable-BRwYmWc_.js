import{f as k,j as e,aa as tt}from"./index-BrDJVfbA.js";import{F as C,l as it,k as I}from"./style-BnSHECvd.js";import{B as et}from"./Button-DNYaW8_g.js";const nt=({columns:h,data:L,filteredData:B,searchTerm:N,highlightText:M,selectAll:O,selectedItems:j,handleSelectAllChange:T,handleCheckboxChange:E,handleEdit:m,canEdit:R,handleDelete:W,handleDeleteSelected:F,rowsPerPage:x,page:w,handleChangePage:st,handleChangeRowsPerPage:D,expandedRows:_,toggleRowExpansion:X,renderExpandedRow:q,renderCustomActions:$,uiVariant:G="default",externalPagination:J=!1,paginationComponent:K=null,forceHorizontalScroll:n=!1,selectionEnabled:g=!0,showBulkDelete:Q=!0})=>{const y=m||W||$,b=B||L||[],[l,U]=k.useState(window.innerWidth<768),[o,V]=k.useState(0),i=G==="app",c=k.useRef(null),r=50,a=n?92:80,z=t=>Number(t.width||t.minWidth||140),u=h.reduce((t,s)=>t+z(s),0),A=(g?r:0)+(y?a:0),f=A+u,v=i&&o>0&&(n||l)&&f>o,S=i&&n?f:i&&o>0?v?f:o:f,Y=i&&o>0&&!v?Math.max(o-A,0):u,p=t=>{const s=z(t);return!i||n||v||o<=0||u<=0?s:s/u*Y};k.useEffect(()=>{const t=()=>{U(window.innerWidth<768),c.current&&V(c.current.clientWidth||0)};t();let s;return typeof ResizeObserver<"u"&&c.current&&(s=new ResizeObserver(t),s.observe(c.current)),window.addEventListener("resize",t),()=>{window.removeEventListener("resize",t),s&&s.disconnect()}},[]),k.useEffect(()=>{if(c.current&&l){const t=c.current;setTimeout(()=>{t.scrollLeft=t.scrollWidth-t.clientWidth},100)}},[l,b]);const Z=i?{backgroundColor:"white",borderRadius:0,padding:0,margin:0,width:"100%",maxWidth:"100%",minWidth:0}:{boxShadow:"0 0 15px rgba(0, 0, 0, 0.1)",backgroundColor:"white",borderRadius:"8px",padding:"15px",margin:"10px 0",width:"100%"},H=i?"app-table":void 0,P=i?"sticky-table-container app-table-scroll":"sticky-table-container";return e.jsxs("div",{className:`expand-table-container ${i?"app-expand-table":""}`,style:Z,children:[e.jsx("style",{dangerouslySetInnerHTML:{__html:`
