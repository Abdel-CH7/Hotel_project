...
const [villeFilter, setVilleFilter] = useState('');
  ...
  useEffect(() => {
    ...
    // If any of the data is not found in local storage, fetch it from the API
  ...
  const validateForm = () => {
    ...
    // Validation pour le secteur d'activité
  if (!formData.secteur_id) {
    newErrors.secteur_id = 'Le secteur d\'activité est obligatoire.';
    isValid = false;
  } else {
  ...
  if (!formData.CodeClient) {
    newErrors.CodeClient = 'Le code client est obligatoire.';
    isValid = false;
  } else {
    ...
    date_fin:"",
      ...
      if (error.response) {
        ...
        setErrors({
          ...
          secteur_id: serverErrors.secteur_id ? serverErrors.secteur_id[0] : "", // Ajoutez cette ligne
...
console.log(selectedProductsData)
      ...
      if (error.response) {
        ...
        setErrors({
          ...
          zone_id: serverErrors.zone_id ? serverErrors.zone_id[0] : "",
          region_id: serverErrors.region_id ? serverErrors.region_id[0] : "",
          secteur_id: serverErrors.secteur_id ? serverErrors.secteur_id[0] : "",
          ice: serverErrors.ice ? serverErrors.ice[0] : "",
          code_postal: serverErrors.code_postal
            ? serverErrors.code_postal[0]
            : "",
