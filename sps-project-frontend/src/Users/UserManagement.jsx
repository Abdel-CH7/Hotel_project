        ...
        <Modal show={hasEditor} onHide={closeEditor} centered dialogClassName="user-editor-modal">
          <Form onSubmit={submitUser}>
            ...
            <Modal.Body>
              ...
              <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Nom complet</RequiredLabel></Form.Label><Form.Control name="name" value={form.name} onChange={handleFormChange} isInvalid={Boolean(fieldError(formErrors, "name"))} disabled={submitting} aria-required="true" /><Form.Control.Feedback type="invalid">{fieldError(formErrors, "name")}</Form.Control.Feedback></Form.Group>
              <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Email</RequiredLabel></Form.Label><Form.Control type="email" name="email" value={form.email} onChange={handleFormChange} isInvalid={Boolean(fieldError(formErrors, "email"))} disabled={submitting} aria-required="true" /><Form.Control.Feedback type="invalid">{fieldError(formErrors, "email")}</Form.Control.Feedback></Form.Group>
              <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Rôle</RequiredLabel></Form.Label><Form.Select name="role" value={form.role} onChange={handleFormChange} isInvalid={Boolean(fieldError(formErrors, "role"))} disabled={submitting || editor?.id === currentUser?.id} aria-required="true"><option value="staff">Employé</option><option value="admin">Administrateur</option></Form.Select><Form.Control.Feedback type="invalid">{fieldError(formErrors, "role")}</Form.Control.Feedback></Form.Group>
              {!editor && <>
                <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Mot de passe temporaire</RequiredLabel></Form.Label><Form.Control type={showEditorPassword ? "text" : "password"} name="password" autoComplete="new-password" value={form.password} onChange={handleFormChange} isInvalid={Boolean(fieldError(formErrors, "password"))} disabled={submitting} aria-required="true" /><Form.Control.Feedback type="invalid">{fieldError(formErrors, "password")}</Form.Control.Feedback></Form.Group>
                <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Confirmation du mot de passe</RequiredLabel></Form.Label><Form.Control type={showEditorPassword ? "text" : "password"} name="password_confirmation" autoComplete="new-password" value={form.password_confirmation} onChange={handleFormChange} disabled={submitting} aria-required="true" /></Form.Group>
        ...
        <Modal show={Boolean(passwordTarget)} onHide={() => !submitting && setPasswordTarget(null)} centered>
          <Form onSubmit={submitPasswordReset}>
            ...
            <Modal.Body>
              ...
              <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Nouveau mot de passe</RequiredLabel></Form.Label><Form.Control type={showResetPassword ? "text" : "password"} autoComplete="new-password" value={passwordForm.password} onChange={(event) => { setPasswordForm((previous) => ({ ...previous, password: event.target.value })); setPasswordErrors((previous) => ({ ...previous, password: "" })); }} isInvalid={Boolean(fieldError(passwordErrors, "password"))} disabled={submitting} aria-required="true" /><Form.Control.Feedback type="invalid">{fieldError(passwordErrors, "password")}</Form.Control.Feedback></Form.Group>
              <Form.Group className="mb-3"><Form.Label><RequiredLabel required>Confirmation</RequiredLabel></Form.Label><Form.Control type={showResetPassword ? "text" : "password"} autoComplete="new-password" value={passwordForm.password_confirmation} onChange={(event) => setPasswordForm((previous) => ({ ...previous, password_confirmation: event.target.value }))} disabled={submitting} aria-required="true" /></Form.Group>
